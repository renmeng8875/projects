...
<form id="fm_es" action="${ctx}/gamePrizes/add.do" method="post" onSubmit="return chkForm(this)">
<input type="hidden" name="csrfToken" value="${csrfToken}"/>
<input type="hidden" name="playerid" value="${gameprizes.prizesid}" />
<div class="pad10">
  <div class="adm-text ul-float">
     <ul class="clearfix">
     
      <li>
      	 <span class="mr0 m" style="float:left;">所属活动名称：</span>
      ...
      <li>
         ...
         <span style="float:left;"><input type="text" id="prizesname" datatype="s2-50" nullmsg="奖品名称不能为空" errormsg="奖品名称长度为2~50个字符" name="prizesname" value="${gameprizes.prizesname}"/></span>
      ...
      <li>
         ...
         <span style="float:left;"><input type="text" id="priority" datatype="ns1-99" nullmsg="排序值不能为空" errormsg="顺序为1～99数字" name="priority" /></span>
         <div class="Validform_checktip"></div>
         <span>&nbsp;</span>
      </li>
       <li>

...
function itemclick()
{
    ...
    var ids = [];
   	...
   	$.ajax({
	   type: "POST",
	   url: "${ctx}/rolemanage/grantcat.do?roleId=${roleManage.roleId}",
	   data: "idstr="+idstr+"&csrfToken=${csrfToken}",
	   success: function(msg)
	   {
	     if(msg.status=='0')
	     {
	    	 alert("${roleManage.roleName}的栏目权限分配成功！"); 
	     }
...
<h2 class="adm-title">
<a class="title" href="javascript:;">角色管理 - <font color="green">${roleManage.roleName }</font>&nbsp;&nbsp;栏目权限设置</a>

 ...
 * @date 2015/7/23.
 */
public class DaemonClientServiceFactoryBean implements FactoryBean<DaemonClientService> {
    private Logger logger = LoggerFactory.getLogger(DaemonClientServiceFactoryBean.class);

var firebug = {
  ...
  init:function(_css){
    var i,
		...
		iconTitle = "点击此图标显示FireBugLite窗口,显示主窗口快捷键:\
		F12或Control+Shift+L或Shift+Enter;\
		\n按住Control键点击此图标可将其隐藏!";
    with(firebug){
      ...
      el.button.inspect = new lib.element("A").attribute.set("title","点击查看页面中的元素").attribute.addClass("Button").event.addListener("click",internal.targetWindow.firebug.d.inspector.toggle).update("查找元素").insert(el.button.container);
      ...
      el.button.newWindow = new lib.element("A").attribute.set("title","在新窗口中打开FireBugLite").attribute.addClass("Button NewWindow").event.addListener("click", win.newWindow).insert(el.button.container);

      if(!internal.isPopup){
        el.button.maximize = new lib.element("A").attribute.set("title","还原").attribute.addClass("Button Maximize").event.addListener("click",win.maximize).insert(el.button.container);
        el.button.minimize = new lib.element("A").attribute.set("title","最小化").attribute.addClass("Button Minimize").event.addListener("click",win.minimize).insert(el.button.container);
        el.button.close = new lib.element("A").attribute.set("title","隐藏").attribute.addClass("Button Close").event.addListener("click",win.hide).insert(el.button.container);
      }
      ...
      el.nav.console = new lib.element("A").attribute.addClass("Tab Selected").event.addListener("click",lib.util.Curry(d.navigate,window,"console")).update("控制台").insert(el.nav.container);
      ...
      if(!internal.isPopup){
        el.nav.scripts = new lib.element("A").attribute.addClass("Tab").update("脚本").event.addListener("click",lib.util.Curry(d.navigate,window,"scripts")).insert(el.nav.container);
      }
      ...
      el.nav.options = new lib.element("A").attribute.addClass("Tab Button Options").update("选项&nbsp;&nbsp;&nbsp;&nbsp;").event.addListener("click", settings.toggle).insert(el.nav.optionsdiv);
      ...
      el.left.console.mlButton = new lib.element("A").attribute.set("title","多行模式").attribute.addClass("MLButton").event.addListener("click",d.console.toggleML).insert(el.left.console.container);
      ...
      el.left.console.input = new lib.element("INPUT").attribute.set("type","text").attribute.addClass("Input").event.addListener("keydown",listen.consoleTextbox).insert(
          new lib.element("DIV").attribute.set("title","输入代码,按回车键执行!").attribute.addClass("InputContainer").insert(el.left.console.container)
      );

      el.right.console = {};
      el.right.console.container = new lib.element("DIV").attribute.addClass("Console Container").insert(el.right.container);
      el.right.console.mlButton = new lib.element("A").attribute.set("title","单行模式").attribute.addClass("MLButton CloseML").event.addListener("click",d.console.toggleML).insert(el.right.console.container);
      ...
      el.right.console.run = new lib.element("A").attribute.set("title","运行输入的代码").attribute.addClass("Button").event.addListener("click",listen.runMultiline).update("运行").insert(el.right.console.container);
      el.right.console.clear = new lib.element("A").attribute.set("title","清除输入的代码").attribute.addClass("Button").event.addListener("click",lib.util.Curry(d.clean,window,el.right.console.input)).update("清除").insert(el.right.console.container);

      el.button.console = {};
      el.button.console.container = new lib.element("DIV").attribute.addClass("ButtonSet").insert(el.button.container);
      el.button.console.clear = new lib.element("A").attribute.set("title","清空控制台").attribute.addClass("Button").event.addListener("click",d.console.clear).update("清除").insert(el.button.console.container);
      ...
      el.right.html.nav.computedStyle = new lib.element("A").attribute.addClass("Tab Selected").event.addListener("click",lib.util.Curry(d.html.navigate,firebug,"computedStyle")).update("样式").insert(el.right.html.nav.container);
      ...
      el.right.css.nav.runCSS = new lib.element("A").attribute.set("title","输入CSS规则,例如:\nbody {\n color:blue;\n}").attribute.addClass("Tab Selected").update("应用CSS规则").insert(el.right.css.nav.container);
      ...
      el.right.css.run = new lib.element("A").attribute.addClass("Button").event.addListener("click",listen.runCSS).update("应用").insert(el.right.css.container);
      el.right.css.clear = new lib.element("A").attribute.addClass("Button").event.addListener("click",lib.util.Curry(d.clean,window,el.right.css.input)).update("清除").insert(el.right.css.container);
      ...
      el.button.scripts.lineNumbers = new lib.element("A").attribute.addClass("Button").event.addListener("click",d.scripts.toggleLineNumbers).update("显示行号").insert(el.button.scripts.container);
      ...
      el.button.dom.label = new lib.element("LABEL").attribute.set("title","输入DOM对象的引用,如:\ndocument.body.firstChild").update("对象路径:").insert(el.button.dom.container);
      ...
      el.button.str.watch = new lib.element("A").attribute.addClass("Button").event.addListener("click",lib.util.Curry(d.navigate,window,"xhr")).update("后退").insert(el.button.str.container);
      ...
      el.button.xhr.label = new lib.element("LABEL").attribute.set("title","输入一个XHR对象的引用").update("XHR 全局对象:").insert(el.button.xhr.container);
      el.button.xhr.textbox = new lib.element("INPUT").event.addListener("keydown",listen.xhrTextbox).insert(el.button.xhr.container);
      el.button.xhr.watch = new lib.element("A").attribute.addClass("Button").event.addListener("click",listen.addXhrObject).update("查看").insert(el.button.xhr.container);
      ...
      el.settings.container = new lib.element("DIV").child.add(
        new lib.element("DIV").attribute.addClass("Header").child.add(
          new lib.element().attribute.addClass("Title").update('Firebug Lite 设置')
        )
      ...
      el.settings.content.child.add(document.createTextNode("开启时即显示窗口"));
      ...
      el.settings.content.child.add(document.createTextNode("当FireBug可用时隐藏"));
      new lib.element("BR").insert(el.settings.content);
      ...
      el.settings.content.child.add(document.createTextNode("隐藏DOM函数"));
      new lib.element("BR").insert(el.settings.content);
      ...
      el.settings.content.child.add(document.createTextNode("覆盖window.console"));
      new lib.element("BR").insert(el.settings.content);
      ...
      el.settings.content.child.add(document.createTextNode("当隐藏时显示图标"));
      new lib.element("BR").insert(el.settings.content);
      ...
      el.settings.content.child.add(document.createTextNode("在弹出窗口中打开"));
      new lib.element("BR").insert(el.settings.content);
      el.settings.content.child.add(document.createTextNode("文本内容显示字符前"));
      el.settings.textNodeChars = new lib.element("INPUT").attribute.set("type","text").attribute.set("title","文本节点只显示前几个字符,0表示不限制!").attribute.addClass("SettingsTextbox").insert(el.settings.content);
      el.settings.content.child.add(document.createTextNode("个"));
      ...
      el.settings.resetButton = new lib.element("INPUT").attribute.set("type","button").update("重置").event.addListener("click",settings.reset).insert(el.settings.buttonLeftDiv);
      el.settings.buttonRightDiv = new lib.element("DIV").attribute.addClass("ButtonsRight").insert(el.settings.buttonDiv);
      el.settings.cancelButton = new lib.element("INPUT").attribute.set("type","button").update("取消").event.addListener("click",settings.hide).insert(el.settings.buttonRightDiv);
      el.settings.buttonRightDiv.child.add(document.createTextNode(" "));
      el.settings.saveButton = new lib.element("INPUT").attribute.set("type","button").update("保存").event.addListener("click",settings.saveClicked).insert(el.settings.buttonRightDiv);
      ...
      if (!fi.popupWin) {
        ...
        if(!fi.popupWin) {
          ...
          /*  alert("Unable to detect the following script \"" + firebug.internal.liteFilename +
			...
			alert("找不到此脚本文件:\"" + firebug.internal.liteFilename +
			"\" ... 假如脚本文件已经被重命名,请将firebug.internal.liteFilename的值设置为新的脚本文件的文件名!");
    ...
    console:{
      ...
      printException: function(_exception){
        with(firebug){
          ...
          d.console.addLine().attribute.addClass("Error").update("<strong>错误: </strong>"+message,true);
        }
      },
      eval:function(_cmd){
        var result;
      ...
      cmd:{
        ...
        group:function(){
          with(firebug){
            d.console.cmd.log.apply(this, ["不支持 console.group"]);
          }
        },
        groupEnd:function(){
          with(firebug){
            d.console.cmd.log.apply(this, ["不支持 console.groupEnd"]);
          }
        },
        profile:function(){
          with(firebug){
            d.console.cmd.log.apply(this, ["不支持 console.profile"]);
          }
        },
        profileEnd:function(){
          with(firebug){
            d.console.cmd.log.apply(this, ["不支持 console.profileEnd"]);
          }
        }
      }
    },
          ...
          // array, hash
            ...
            if(isArray){
              ...
              for(var key in _value){
                ...
                if((_inObject||_inArray)&&i>3){
                  result.push(" <span class='Strong Gray'>更多</span>");
                  break;
                }
        ...
        with(firebug){
          ...
          try {
            ...
            el.left.scripts.container.child.add(
              new lib.element("DIV").attribute.addClass("CodeContainer").update("<em style='color:#F30;font-style:normal;'>没有访问权限!</em>")
            );
          }
        }
      },
    ...
    xhr:{
      ...
      open:function(){
        with(firebug){
          ...
          el.left.xhr.nameTitle = new lib.element("STRONG").update("对象名称:").insert(el.left.xhr.name);
          ...
          el.left.xhr.statusTitle = new lib.element("STRONG").attribute.set("title","XHR对象的status属性值").update("HTTP 状态码:").insert(el.left.xhr.status);
          ...
          el.left.xhr.readystateTitle =el.left.xhr.nameTitle = new lib.element("STRONG").attribute.set("title","XHR对象的readyState属性值").update("请求状态:").insert(el.left.xhr.readystate);
          ...
          el.left.xhr.responseTitle = new lib.element("STRONG").attribute.set("title","XHR对象的responseText属性值").update("响应:").insert(el.left.xhr.response);

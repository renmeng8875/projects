...
<form id="fm_es" method="post" action="${ctx}/Announce/editAnnounce.do">
<input type="hidden" name="csrfToken" value="${csrfToken}"/>
<input name="announceid" type="hidden" value="${announce.announceid}" />
<div class="pad10">
  <div class="adm-text ul-float">
      ...
      <li>
        ...
        <input class="l mr20" name="announce" id="announce"  type="text" value="${announce.announce}" datatype="*2-50"   nullmsg="请输入公告标题!" errormsg="公告标题长度必须在2~50位字符范围内!" />
         <span>&nbsp;</span>	
      <li>
      	 <span class="need" style="float:left;">*</span>
      	 <span class="mr0 m" style="float:left;">起始日期：</span>
         <span style="float:left;"><input type="text" id="starttime" name="starttime" value="${announce.startTimeStr}"/></span>
      ...
      <li>
        ...
        <span style="float:left;"><input type="text" id="endtime" name="endtime" value="${announce.endTimeStr}"/></span>
      ...
      <li>
        ...
        <textarea name="content" id="content" cols="45" rows="5" datatype="*2-100" errormsg="公告内容长度必须在2~100位字符范围内!"   nullmsg="请输入公告内容!">${announce.content}</textarea><span id="contentTip"></span>
      </li>
    </ul>
  </div>
</div>
<div class="adm-btn-big"><input type="submit" value="修&nbsp;&nbsp;改" /></div>
</form>
</body>
</html>
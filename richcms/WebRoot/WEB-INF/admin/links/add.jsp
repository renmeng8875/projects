...
$(function(){
	$('#logourl').uploadify({
	    ...
	    'onUploadSuccess':function(file, data, response)
	    {
        	...
        	container.append('<input type="hidden" name="logoPx" value="'+jsonObj.imagePx+'" />');
	    }
	});
...
<form name="fm_es" id="fm_es" method="post" action="${ctx}/Links/add.do">
...
<div class="pad10">
 <table style="font-size:12px;color:#444;line-height:32px;">
    <tr>
	     <td width="80">网站名称：</td>
		 <td>
		 	<input style="width:188px;" class="l"  name="site" id="site" type="text" value="${linkinfo.site}" datatype="*2-50" sucmsg="验证通过,名称可用!" nullmsg="请输入网站名称" errormsg="网站名称长度必须在3～50范围内"  ignore="ignore" ajaxurl="${ctx}/Links/checkName.do?csrfToken=${csrfToken}"/>
		 </td>
		 <td><div class="Validform_checktip"></div></td>
	</tr>
	 <tr>
	     <td width="80">网站网址：</td>
		 <td> <input class="l" style="width:188px;" datatype="url" nullmsg="请输入网址链接" errormsg="网站链接格式不正确" name="linkurl" id="linkurl"  type="text" value="" /></td>
		 <td><div class="Validform_checktip"></div></td>
	</tr>
	 <tr>
	     <td width="80">网站优先级:</td>
		 <td> <input class="l" style="width:188px;" name="priority" id="priority"  type="text" value="" datatype="n1-3" errormsg="网站优先级必须为数字且长度在1-3范围内"/></td>
		 <td><div class="Validform_checktip"></div></td>
	</tr>
	 <tr>
	     <td width="80">网站LOGO：</td>
		 <td>  
		 	<div wrap="imageContainer" id="container1" style="height: 125px;width: 182px;overflow: hidden;padding: 2px;border:2px solid gray;margin: 2px;margin-bottom: 4px;">
      		</div>
	 ...
	 <tr>
		 ...
		 <td> <input class="l" style="width:188px;" datatype="s" nullmsg="请输入网站联系人" errormsg="真实姓名长度必须在2～20范围内" name="contact" id="contact"  type="text" value="" /></td>
		 <td><div class="Validform_checktip"></div></td>
	</tr>
	<tr>
	     <td width="80">网站描述:</td>
		 <td>  <textarea class="l" name="mem" id="mem" style="height:100px;width: 188px"></textarea></td>
		 <td><div class="Validform_checktip"></div></td>
	</tr>
	 <tr>

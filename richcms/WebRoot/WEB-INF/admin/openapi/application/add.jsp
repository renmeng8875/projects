...
<div id="tab1" style="overflow:hidden; border:1px solid #A3C0E8; "> 
            <div title="分配角色">
            <form action="${ctx }/application/addApp.do" method="post" id="fm_es">
              <input type="hidden" name="csrfToken" value="${csrfToken}"/>
              <table style="font-size:12px;color:#444;line-height:32px; margin:10px;">
				
				 <tr>
					 <td width="80"><span class="need" >*</span>应用名称:</td>
					 <td><input class="tdinput" type="text" value="${app.appName}" name="appName" datatype="*2-50" sucmsg="验证通过!" nullmsg="应用名称不能为空!" errormsg="2到50任意字符 !" /></td>
				 </tr>
				 <tr>

package com.yy.ent.mobile.thrift.client.utils;
...
public final class ThriftClientUtils {
	...
	private static ConcurrentMap<Class<?>, Set<String>> interfaceMethodCache = new ConcurrentHashMap<Class<?>, Set<String>>();
